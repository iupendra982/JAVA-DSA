...
// [0,1,2,4,5,6,7] might  be rotated  at pivot  index 3 and become [4,5,6,7,0,1,2].Given the 
// array nums after the possible rotation and an integer target, returnthe index oftarget if 
// it is in nums, or -1 if it is not in nums.You must write an algorithm with O(log n) runtime
// complexity
